...
Most of that development has been done in Clojure and, whenever possible, using [lein-test-refresh](https://github.com/jakemcc/test-refresh) with [terminal-notifier](https://github.com/julienXX/terminal-notifier) to have my tests automatically run and a notification shown with the status of the test run.
...
After some searching I stumbled across [this](https://github.com/julienXX/terminal-notifier/issues/115) GitHub issue which helped solve the problem.
