...
Since I wrote `lein-autoexpect`, a continous tester for `expectations`, it was easy for me to fork it and and create [lein-test-refresh](https://github.com/jakemcc/test-refresh).
...
[lein-test-refresh](https://github.com/jakemcc/test-refresh) watches the source and test directories specified in your `project.clj` and reloads code when files changes.
...
I hope you enjoy [lein-test-refresh](https://github.com/jakemcc/test-refresh).
